...
double  MKL_Get_Max_Cpu_Frequency(void); /* get max CPU frequency in GHz */
#define mkl_get_max_cpu_frequency MKL_Get_Max_Cpu_Frequency

double  MKL_Get_Clocks_Frequency(void); /* get clocks frequency in GHz */
